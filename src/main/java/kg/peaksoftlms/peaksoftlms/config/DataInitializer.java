...
//
//        lesson1.setPresentations(Arrays.asList(presentation));
//        lesson1.setTasks(Arrays.asList(task));
//        lesson1.setTests(Arrays.asList(test));
//        lesson1.setVideos(Arrays.asList(video));
//
...
//        course.setLesson(Arrays.asList(lesson1));
//
