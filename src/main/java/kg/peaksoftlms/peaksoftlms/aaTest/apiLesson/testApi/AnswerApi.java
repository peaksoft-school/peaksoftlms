...
import kg.peaksoftlms.peaksoftlms.aaTest.service.lesson.test.AnswerService;
...
public class AnswerApi {
    ...
    @PostMapping("/save/{id}")
    public ResponseEntity<TestResultResponse> saveUserAnswers(@RequestBody List<AnswerRequest> answerRequestList, @PathVariable Long id) {
        try {
